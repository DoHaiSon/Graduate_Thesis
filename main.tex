...
\usepackage[left=3.5cm,right=2cm,top=3.0cm,bottom=3cm,footskip=40pt]{geometry}
...
\newpage
\input{Chap1_Background.tex}
\newpage
\input{Chap2_GNUSDR.tex}
\newpage
\input{Chap3_Main_new.tex}
\newpage
%\input{Chap4_KQ.tex}
%\newpage
\input{Chap5_Ketluan.tex}
%\newpage
\newpage

%\addcontentsline{toc}{chapter}{\MakeUppercase{Phụ lục}}
\appendix
\input{phulucA.tex}
%\input{Chap5_Congbo}
...
\addcontentsline{toc}{chapter}{\MakeUppercase{Tài liệu tham khảo}}
...
%\bibliographystyleNew{ieee}
%\bibliographyNew{library}
